   ...
   <div class="orders">
      <div class="row">
         <div class="col-xl-12">
            <div class="card">
               <div class="card-body">
                  <h4 class="box-title"><a href="{{ Route('admin.teacher.view') }}">Teacher</a> </h4>
               </div>
               <div class="card-body-- pb-1">
                  <form class="pb-5 m-3" action="{{ Route('admin.teacher.store') }}" method="POST" encrypt="multipart/form-data">
                     @csrf
                     ...
                     <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="formGroupExampleInput2" name="password" placeholder="name@example.com" required>
                     </div>
                     <div class="form-group">
