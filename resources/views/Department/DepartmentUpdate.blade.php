    ...
    <div class="orders">
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="box-title"><a href="{{ Route('department.view') }}">Department</a> </h4>
                    </div>
                    <div class="card-body-- pb-1">
                        <form class="pb-5 m-3" action="{{ Route('department.update',$department->id) }}" method="POST" encrypt="multipart/form-data">
                            @csrf
