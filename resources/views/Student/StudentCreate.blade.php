   ...
   <div class="orders">
      <div class="row">
         <div class="col-xl-12">
            <div class="card">
               <div class="card-body">
                  <h4 class="box-title"><a href="{{ Route('admin.student.view') }}">Student</a> </h4>
               </div>
               <div class="card-body-- pb-1">
                  <form class="pb-5 m-3" action="{{ Route('admin.student.store') }}" method="POST" encrypt="multipart/form-data">
                     @csrf
